...
function addActionsForHTMLUI() {
  ...
  document.getElementById('makeDrawing').onclick = function () {
    g_shapesList = [];
    renderAllShapes();
    makeDrawing();
  };
...
function makeDrawing() {
  ...
  //mtg logo
  createTriangle([-2, 1.5], [2, 1.5], [0, -2.5], [0, -0.2, 0], 10, 0);
  createTriangle([-2, 0], [2, 0], [-2, -2.5], [0, 0, 0], 10, 0);
  createTriangle([2, -2.5], [2, 0], [-2, -2.5], [0, 0, 0], 10, 0);
  createTriangle([-2, 0], [2, 0], [-2, -2.5], [0.2, 0, 0], 10, 0);
  createTriangle([2, -2.5], [2, 0], [-2, 0], [-0.2, 0, 0], 10, 0);
  createTriangle([-4, 0], [4, 0], [-4, -2.5], [0, 0.185, 0], 15, 0);
  createTriangle([4, -2.5], [4, 0], [-4, -2.5], [0, 0.185, 0], 15, 0);
  createTriangle([-2, 0], [2, 0], [-2, -2.5], [0.43, 0.185, 0], 15, 0);
  createTriangle([2, -2.5], [2, 0], [-2, 0], [-0.43, 0.185, 0], 15, 0);
  createTriangle([-2, 1.5], [2, 1.5], [0, 15], [0, 0.1, 0], 10, 0);
  createTriangle([-2, 1.5], [2, 1.5], [0, 12], [-0.25, 0.1, 0], 10, 0);
  createTriangle([-2, 1.5], [2, 1.5], [0, 9], [-0.5, 0.1, 0], 10, 0);
  createTriangle([-2, 1.5], [2, 1.5], [0, 12], [0.25, 0.1, 0], 10, 0);
  createTriangle([-2, 1.5], [2, 1.5], [0, 9], [0.5, 0.1, 0], 10, 0);
